...
7. prowadzenie spraw związanych z funkcjonowaniem przestrzeni;
8. dbanie o majątek, bezpieczeństwo i prawidłowe funkcjonowanie Stowarzyszenia;
9. uchwalanie planów działania i budżetu;
10. uchwalanie szczegółowych zasad wykonawczych dotyczących korzystania z przestrzeni, o ile nie są one sprzeczne z niniejszym Regulaminem ani z zasadami przyjętymi przez Stowarzyszenie;
